...
class Developer extends Admin_Controller
{
	...
	public function index()
	{
		...
		if ($this->input->post('delete'))
		{
			...
			if (is_array($checked) && count($checked))
			{
				foreach ($checked as $file)
				{
					...
					$this->activity_model->log_activity($this->current_user->id, 'delete', 'logs', $file);
				}
		...
		elseif ($this->input->post('delete_all'))
		{
			...
			$this->activity_model->log_activity($this->current_user->id, 'delete all', 'logs');
	...
	public function enable()
	{
		...
		if ($this->input->post('save'))
		{
			...
			if (write_config('config', array('log_threshold' => $_POST['log_threshold'])))
			{
				...
				// Log the activity
				$this->activity_model->log_activity( intval ( $this->current_user->id ), 'edit', 'logs');
