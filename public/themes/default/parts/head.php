...
<html lang="en">
  <head>
    ...
    <link rel="apple-touch-icon" sizes="72x72" href="<?php echo assets_url(); ?>images/apple-touch-icon-72x72.png">
    <link rel="apple-touch-icon" sizes="114x114" href="<?php echo assets_url(); ?>images/apple-touch-icon-114x114.png">
